...
- 불러오는 항목  
    ...
    - 카테고리(태그)
    - ISBN
- 종이책과 전자책이 각각 별도의 메타데이터 소스로 등록됩니다. <br> (책 정보 편집 화면에서 `Yes24`, `Yes24-eBook` 을 각각 켜고 끌 수 있습니다.)
- 저자는 글쓴이가 먼저 오도록 정렬되며, 역자와 감수자는 뒤에 표시됩니다.  
- 평점은 10점 만점을 5점 만점으로 내림 변환합니다.  
- 검색 결과 제목을 누르면 Yes24 상품 페이지로 이동됩니다.
